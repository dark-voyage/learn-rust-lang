...
<Callout emoji="✅">
  Rust juda tez va xotirada tejamkor: ish vaqti yoki axlat yig'uvchisiz, u muhim
  xizmatlarni quvvatlantirishi, o'rnatilgan qurilmalarda ishlashi va boshqa
...
<Callout emoji="✅">
  Rust ajoyib hujjatlarga, foydali xato xabarlariga ega qulay kompilyatorga va
  yuqori darajadagi asboblarga ega - integratsiyalashgan paket menejeri va
  qurish vositasi, avtomatik yakunlash va turdagi tekshiruvlar bilan aqlli ko'p
  muharrirlarni qo'llab-quvvatlash, avtomatik formatlovchi va boshqalar.
</Callout>

## Ishlab chiqarishda

<Callout emoji="✅">
  Dunyo bo'ylab yuzlab kompaniyalar bugungi kunda ishlab chiqarishda Rustdan
  tez, kam resursli, platformalararo yechimlar uchun foydalanmoqda.
